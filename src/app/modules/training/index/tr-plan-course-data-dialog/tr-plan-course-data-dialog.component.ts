...
@Component({
  selector: 'app-tr-plan-course-data-dialog',
  templateUrl: './tr-plan-course-data-dialog.component.html',
  styleUrls: ['./tr-plan-course-data-dialog.component.css']
})
export class TrPlanCourseDataDialogComponent {
...
trainingCenterName: any;
  constructor(private formBuilder : FormBuilder,
    ...
    private dialogRef : MatDialogRef<TrPlanCourseDataDialogComponent>,
