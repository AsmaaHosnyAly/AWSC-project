...
@Component({
  selector: 'app-pro-plan-type-dailog',
  templateUrl: './pro-plan-type-dailog.component.html',
  styleUrls: ['./pro-plan-type-dailog.component.css']
})
export class ProPlanTypeDailogComponent {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogRef: MatDialogRef<ProPlanTypeDailogComponent>,
  ...
  async addPlanType() {
    if (!this.editData) {
      ...
      if (this.PlanTypeForm.valid) {
        ...
        this.api.postPlanType(this.PlanTypeForm.value)
          .subscribe({
            next: (res) => {
  ...
  updatePlanType() {
    ...
    this.api.putPlanType(this.PlanTypeForm.value)
      .subscribe({
        next: (res) => {
